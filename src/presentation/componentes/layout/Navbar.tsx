        ...
        <nav className="bg-blue-600 text-white shadow-md">
            <div className="max-w-7xl mx-auto px-4">
                <div className="flex justify-between h-16">
                    ...
                    <div className="hidden md:flex">
                        ...
                        <NavLink to="/countries" active={isActive("/countries")} text="Paises" icon={<Globe size={18} />} />
                        <NavLink to="/persons" active={isActive("/persons")} text="Personas" icon={<Users size={18}/>} />
                        <NavLink to="/roles" active={isActive("/roles")} text="Roles" icon={<Users size={18}/>} />
                    </div>
                    {/* Boton de menu movil */}
            ...
            {isMenuOpen && (
                <div className="md:hidden">
                    ...
                    <MobileNaveLink to="/roles" active={isActive("/roles")} icon={<Users size={18} />} text="Roles" />
