                ...
                <tr key={role.id} className="hover:bg-gray-200">
                  ...
                  <td className="p-2">
                    <div className="flex flex-row items-center gap-2">
                      ...
                      <Link to={`/roles/${role.id}/delete`} className="flex flex-row items-center justify-center gap-2 bg-blue-500 text-white hover:bg-blue-600 p-2 rounded-md cursor-pointer" >
                        <Trash size={18} />
                      </Link>
                    </div>
                  </td>
